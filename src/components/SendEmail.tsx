...
function SendEmail() {
    return (
        <div className='flex flex-col my-20 items-center justify-center p-6'>
            ...
            <form className='flex flex-col items-center w-2/5 lg:flex-row gap-4'>
                <input
                    type='email'
                    placeholder='Digite seu e-mail'
                    className='flex-1 px-2 py-2 border text-center border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500'
                />
                <button
                    type='submit'
